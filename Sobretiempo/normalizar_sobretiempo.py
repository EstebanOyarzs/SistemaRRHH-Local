...
el acumulado completo del año a esa fecha, no hace falta mergear meses).
...
from sqlalchemy import Boolean, Date  # noqa: E402

from backend.dashboards.sobretiempo.db import (  # noqa: E402
    DB_PATH,
    TABLE_DETALLE,
    TABLE_PRESUPUESTO,
    TABLE_RESUMEN,
...
# ------------------------------------------------------------------------
# 5. CARGA A SQLITE (reemplaza por completo las 4 tablas cada corrida)
# ------------------------------------------------------------------------
